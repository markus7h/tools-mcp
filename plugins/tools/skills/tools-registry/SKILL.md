---
name: tools-registry
description: "MUSS geprüft werden, bevor du für eine Aufgabe Bash-Kommandos, Ad-hoc-Scripts oder Eigenbau-Code schreibst — die tools-registry hat fertige, geprüfte MCP-Tools dafür. Deckt ab: Dokument-Konvertierung (Markdown/Word/HTML → PDF), PDF-Text-Extraktion, Datei-Previews, mehrstufige Pipelines, Settings-Sync, Token-Messung. Tools: docx_to_pdf, dotclaude_install, echo, env_align, head_lines, html_to_pdf, magic3_design_install, md_to_pdf, measure_savings, paperless_tag_no_ocr, pdf_to_text, settings_sync, subagent_models."
---
